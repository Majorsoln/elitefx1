...
| 2026-07-04 | **TEAM OPERATING SYSTEM** | Directive ya Project Director: timu ya AI agents (IMPLEMENTER-A · RESEARCHER-K · AUDITOR) inayoendeshwa kwa prompts za Chief; Operator (Japhet) = binadamu pekee mwenye PC/data; **memory file kwa kila member** (`docs/team/memory/`) + Session Ritual (bootstrap→work→close) + **STATUS block kila jibu la Chief** (TEAM_PROTOCOL §4). Repo = ubongo wa pamoja. |
