...
*Last updated: 2026-07-05 (batch 6 APPROVED) | Lessons: 36 (34 ACTIVE + 2 CANDIDATE — 017/018 OOS gate) — METHOD 17 · MARKET-CONDITIONAL 7 · GOVERNANCE 12 | Backlog (K1): findings/phases zilizobaki ≈ 7–17*
...
| LESSON-032@v1 | GOVERNANCE | A frozen layer reopens only on a proven downstream need; freeze binds the interface, not the implementation | ACTIVE | P90/P62/V6·V8·V11/F-005 |
| LESSON-033@v1 | METHOD | Heterogeneous winners → model a population and rank it; classification discards ordering signal | ACTIVE | F-023/F-008/Phase 6.5/P23 |
| LESSON-034@v1 | METHOD | Confidence is a ranking dimension co-equal with EV; but CCS-selection is not tradable (−0.757 OOS) | ACTIVE | F-024/F-025/Phase 7-8/P24-25 |
| LESSON-035@v1 | GOVERNANCE | Evidence is an immutable contract; aggregation is an external, swappable operation | ACTIVE | P67/P68/P83-84/D0-D3 |
| LESSON-036@v1 | GOVERNANCE | Name an era by what is proven, not what is hoped; premature declarations are retracted | ACTIVE | V6.3→V6.4/F-039/P45 |
...
|----------|-------|------|--------|
| GRAPH@v7 | L2 (graph) | `knowledge/graph.json` (+ `graph_selftest.py` · `GRAPH_SCHEMA.md`) | v1-v6 APPROVED; **v7** (2026-07-05, Chief) batch 6 linked — nodes 172 · edges 202, self-test PASS |
