...
MODULES = ["frozen", "decision_object", "evidence_snapshot", "decision_policy", "decision_engine",
           ...
           "rmap", "k4_dataset", "swing_family", "k4_model", "live_engine", "e2e_paper_demo"]     # purity_check=P107; strategy_lab=S1(+R1 boot); WAVE-1 R4/R5/R6; intraday+htf=C2-0; wave_c2a=C2-3 (MZUNGUKO-2); false_break+gold=WAVE-B-prep; rmap=M3-1 + k4_dataset=M3-4 + swing_family=M3-3-S2 + k4_model=M3-5 + live_engine=LIVE-ENGINE (MZUNGUKO-3)
