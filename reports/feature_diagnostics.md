...
*Imezalishwa: 2026-06-17 21:48 | Uthibitisho wa kitakwimu kabla ya modeling*
...
*Normal: skew=0, excess kurtosis=0. **9/9** zina excess kurtosis > 1 (fat tails) → Gaussian HMM itakosea tails. **Ushauri:** tumia Student-t emissions au standardize returns kwa rolling-vol kabla ya HMM. Skew hasi = matukio ya kuanguka makubwa kuliko ya kupanda.*

## 2. Volatility Clustering — ACF ya r² (huhalalisha regime/HMM)
...
## 3. `volume_imbalance` IC — je inatabiri return ya bar inayofuata? (Model 2)
...
## 4. Correlation Stability — je groups za static zinafaa? (Compliance)
